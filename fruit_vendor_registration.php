...
ob_start();
    ...
    if(isset($_POST['submit']) && $_POST['submit']=="Register"){
        ...
        $obj->fruitRegistration($login_id, $vendor_name, $vendor_address, $land_phone, $mobile_phone, $email_id, $username, $password);
...
<form method="post" action="fruit_vendor_registration.php" name="fruit_vendor_registration" enctype="multipart/form-data" class="contact-form">
									<table>
										<tr>
										...
										<tr>
											...
											<td>
                                                                                            <p class="show-all">
                                                                                                    <input type="submit" name="submit" value="Register"  onclick="return fruitVendorValidation()" class="btn-1 btn-1-color-default">
                                                                                            </p>
                                                                                        </td>
										</tr>
									</table>
						...
						<div class="sidebar">
							...
							<!-- BEGIN .sidebar-item .latest-activity -->
                                                        ...
                                                        <img src="images/updated_images/vendor_3.jpg">
